...
public class CopyOfBuildingXMLParser_old {
	 ...
	 */
	public CopyOfBuildingXMLParser_old(InputStream inputStream)
	...
	public void readBuildingAttributes() {
		...
		buildingAmount = Integer.parseInt(xpp.getAttributeValue(null, "amount"));
		buildingInputPower = Integer.parseInt(xpp.getAttributeValue(null, "inputPower"));
		buildingOutputPower = Integer.parseInt(xpp.getAttributeValue(null, "outputPower"));
	...
	public void addRequiredResource(XmlPullParser xpp,
		...
		Log.d( "debug", xpp.getAttributeName(1) );
		Log.d( "debug", xpp.getAttributeValue(null, "amount") );
		
		String reqdResName = xpp.getAttributeValue(null, "name");
		int reqdResAmount = Integer.parseInt(xpp.getAttributeValue(null, "amount"));
		...
		Log.d("debug", "added resource " + reqdResName );
	}
